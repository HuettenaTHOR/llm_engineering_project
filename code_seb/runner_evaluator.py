...
Pure analysis -- touches no model (DESIGN §8). Metric definitions follow DESIGN §4.3:
  ...
  - Wilson 95% CIs on each proportion; metric-at-loop-k; optional McNemar for paired runs (A6).
...
from code_seb.cf_config import default_out_path, load_configs, _short
