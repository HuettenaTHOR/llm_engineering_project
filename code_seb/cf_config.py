...
Kept separate from counterfactual_runner.py so the analysis side (runner_evaluator.py) can load
configs and resolve artifact paths without importing the generation stack (model loading, seeds).
"""
import json
